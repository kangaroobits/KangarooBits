...
static const int64_t MAX_MONEY = 500000000 * COIN; // 500 Million
...
static const int64_t COIN_YEAR_REWARD1 = 10 * CENT; // 
static const int64_t COIN_YEAR_REWARD2 = 5 * CENT; // 
static const int64_t COIN_YEAR_REWARD3 = 3 * CENT; // 
static const int64_t COIN_REWARD1 = 150 * COIN; //
static const int64_t COIN_REWARD2 = 100 * COIN; //
static const int64_t COIN_REWARD3 = 50 * COIN; //
