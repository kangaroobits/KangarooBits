...
#if defined(NDEBUG)
# error "KangaBits cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 1 * 60 * 60; // 1 Hour(s)
...
const string strMessageMagic = "KangaBits Signed Message:\n";
...
bool IsStandardTx(const CTransaction& tx, string& reason)
{
    ...
    BOOST_FOREACH(const CTxIn& txin, tx.vin)
    {
        ...
        // keys. (remKangaBits the 520 byte limit on redeemScript size) That works
...
{
    RenameThread("KangaBits-loadblk");
