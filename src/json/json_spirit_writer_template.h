...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mKangaBits_type;
    ...
    private:
        ...
        void output( const Obj_mKangaBits_type& mKangaBits )
        {
            output( Config_type::get_name( mKangaBits ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mKangaBits ) );
        }
